...
here — this template is the shape, not the content. Treat exact resource
numbers as sensitive if the repo/runbook is or could become public: a
specific vCPU/memory/disk footprint is a usable fingerprint for anyone
sizing an attack against the host. Use ranges or qualitative sizing
("small", "single-vCPU") in anything publicly readable, and keep precise
figures in a private ops doc.
